...
}*/ else if ( $_FILES['userFile']['size'] > 1638480 ) {
   die('<p>Sorry file too large</p></body></html>');
// Connect to database
} else if ( !($link=mysql_connect("localhost","root","")) ) {
...
// Copy image file into a variable
   ...
   $query = 'INSERT INTO image_cloth (type,name,alt,image) VALUES ("' . $_FILES['userFile']['type'] . '","' . $_FILES['userFile']['name']  . '","' . $alt  . '","' . $image . '")';
