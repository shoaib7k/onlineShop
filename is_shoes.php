...
if ( !($link=mysql_connect("localhost","root","")) ) {
   ...
   $query = "SELECT id,name,alt FROM image_shoes";
...
//$j=$i;
	...
	//printf("\n");
        ...
        echo '<img src="gs_shoes.php?id=' . $row['id'] . '" alt="' . $row['alt'] . '" title="' . $row['name']  .'" img align="middle" height="150" width="150"/>' . "\n";
	echo	"<form action='process_cart.php' method='post'>";
	//echo	"<form action='include/sessioncon.php' method='post'>";
